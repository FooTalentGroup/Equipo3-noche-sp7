...
import HistorialIcon from '@/assets/historial-registro-usuario.svg';
import FlechaIzq from '@/assets/navegador-izquierdo.svg';
import FlechaDer from '@/assets/navegador-derecho.svg';
      ...
      <div className="mt-6 flex items-center justify-center gap-1">
        ...
        >
          <div className="flex items-center gap-2">
            <img src={FlechaIzq} alt="Anterior" className="h-4 w-4" />
            Anterior
          </div>
        </button>
        ...
        >
          <div className="flex items-center gap-2">
            Siguiente
            <img src={FlechaDer} alt="Siguiente" className="h-4 w-4" />
          </div>
        </button>
      </div>
    </div>
