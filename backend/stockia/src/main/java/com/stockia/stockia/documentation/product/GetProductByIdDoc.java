...
@Operation(summary = "Obtener producto por ID", description = "Retorna la información completa de un producto específico. "
                +
                "<strong>Solo accesible para usuarios con rol ADMIN o MANAGER.</strong>", security = @SecurityRequirement(name = "bearer-key"))
@ApiResponses({
                @ApiResponse(responseCode = "200", description = "Producto encontrado", content = @Content(examples = @ExampleObject(value = "{\"success\":true,\"message\":\"Producto encontrado\",\"data\":{\"id\":\"123e4567-e89b-12d3-a456-426614174000\",\"name\":\"laptop hp\",\"category\":{\"id\":\"123e4567-e89b-12d3-a456-426614174001\",\"name\":\"Electrónica\"},\"price\":999.99,\"photoUrl\":null,\"currentStock\":10,\"minStock\":5,\"isAvailable\":true,\"hasLowStock\":false}}"))),
