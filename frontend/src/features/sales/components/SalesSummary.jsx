...
export const SalesSummary = () => {
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 sticky top-8 w-[300px] h-[439px]">
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="pt-2 border-t border-gray-200 flex justify-between text-[12px] font-bold text-gray-800">
          <span>Total</span>
          <span>$0.00</span>
        </div>
      </div>
