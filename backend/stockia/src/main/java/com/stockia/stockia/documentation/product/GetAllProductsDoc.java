...
@Operation(summary = "Listar todos los productos con filtros opcionales y paginación", description = "Retorna una página de productos del sistema con capacidad de filtrado avanzado. "
                +
                ...
                +
                "</ul>" +
                "<br><strong>Solo accesible para usuarios con rol ADMIN o MANAGER.</strong>", security = @SecurityRequirement(name = "bearer-key"))
@ApiResponses({
                @ApiResponse(responseCode = "200", description = "Página de productos obtenida exitosamente", content = @Content(examples = @ExampleObject(value = "{\"success\":true,\"message\":\"Productos obtenidos exitosamente\",\"data\":{\"content\":[{\"id\":\"123e4567-e89b-12d3-a456-426614174000\",\"name\":\"laptop hp\",\"category\":{\"id\":\"123e4567-e89b-12d3-a456-426614174001\",\"name\":\"Electrónica\"},\"price\":999.99,\"currentStock\":10,\"minStock\":5,\"isAvailable\":true,\"hasLowStock\":false}],\"pageable\":{\"pageNumber\":0,\"pageSize\":20},\"totalElements\":1,\"totalPages\":1,\"last\":true,\"first\":true,\"size\":20,\"number\":0,\"numberOfElements\":1,\"empty\":false}}"))),
                @ApiResponse(responseCode = "400", description = "Parámetros de búsqueda inválidos", content = @Content(examples = @ExampleObject(value = "{\"statusCode\":400,\"errorCode\":\"BAD_REQUEST\",\"message\":\"Parámetros de búsqueda inválidos\",\"details\":[\"Los parámetros proporcionados no son válidos\"],\"timestamp\":\"2025-11-26T15:10:38.908929300Z\",\"path\":\"/api/products\"}")))
})
