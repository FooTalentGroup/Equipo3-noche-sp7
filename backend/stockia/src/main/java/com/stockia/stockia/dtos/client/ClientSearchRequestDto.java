...
public record ClientSearchRequestDto(
                ...
                @Schema(description = "Nombre del cliente (búsqueda parcial, case-insensitive)", example = "Juan", requiredMode = Schema.RequiredMode.NOT_REQUIRED) String name,

                @Schema(description = "Email del cliente (búsqueda exacta)", example = "juan@example.com", requiredMode = Schema.RequiredMode.NOT_REQUIRED) String email,
