                        ...
                        <div className="border-t border-stokia-neutral-200 pt-4">
                            <div className="flex justify-between items-center mb-3">
                                ...
                                <div className="text-center flex-1">
                                    <p className="font-semibold text-stokia-neutral-900">{reportData.title}</p>
                                </div>
                        ...
                        <table className="w-full text-center border-separate border-spacing-0">
                            ...
                            <tbody className="divide-y divide-stokia-neutral-100 bg-white">
                                {reportData.tableRows.map((row, idx) => (
                                    <tr key={idx} className="[&_td]:text-stokia-neutral-900 [&_td]:text-sm [&_td]:px-4 [&_td]:py-3">
                                        {row.map((cell, cellIdx) => (
                                            <td key={cellIdx} className={cellIdx === 0 ? "text-left font-medium" : ""}>
                                                {cell}
                                            </td>
                                        ))}
                                    </tr>
