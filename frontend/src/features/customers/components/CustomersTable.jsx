import { Trash2, ChevronLeft, ChevronRight, LoaderCircle, ShieldUser } from 'lucide-react';
                ...
                <table className="w-full text-sm">
                    <thead className="text-[14px] bg-slate-200 text-[#404040]">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-left text-gray-700">CLIENTES</th>
                            <th className="px-6 py-3 text-left text-gray-700">CORREO ELECTRÓNICO</th>
