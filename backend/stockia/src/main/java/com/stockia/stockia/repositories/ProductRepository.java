...
public interface ProductRepository extends JpaRepository<Product, UUID> {
         ...
         * Nota: La comparación es case-insensitive para evitar duplicados por
        ...
        /**
         * Busca productos con filtros dinámicos (nombre, categoría, estado de
         * eliminación,
         ...
         * @param includeInactive Incluir productos inactivos (null o false = solo
         *                        activos)
         * @param lowStock        Filtrar solo productos con stock bajo (null o false =
         *                        todos)
