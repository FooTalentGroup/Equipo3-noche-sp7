...
@Documented
@Operation(summary = "Obtener cliente por ID", description = "Retorna los datos de un cliente específico mediante su ID.", parameters = @Parameter(name = "id", description = "ID del cliente", required = true))
@ApiResponses(value = {
